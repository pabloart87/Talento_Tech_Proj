...
export default function Productos() {
  ...
  const [paginaActual, setPaginaActual] = useState(1);
    ...
    useEffect(() => {
    document.title = "Equipamiento informático | Reparaciones";
    ...
    // Meta tags básicos
    updateMetaTag('description', 'Encuentra el repuesto que necesitas para reparar u optimizar tu computadora');
    updateMetaTag('keywords', 'notebook, pc, reparacion, repuestos, pantallas, tarjeta gráfica, ssd, disco duro');
    updateMetaTag('author', '@pablo');
    updateMetaTag('robots', 'index, follow'); //le dice a google que indexe a la busqueda

    // Open Graph
    updateMetaTag('og:title', 'Repuestos informáticos, servicio de reparación', 'property');
    updateMetaTag('og:description', 'Explora el catálogo de repuestos.', 'property');
                  ...
                  <div className="mt-auto">
                    <div className="d-grid gap-2">
                      ...
                      <button
                        ...
                        style={{ backgroundColor: '#1791c5ff', color: 'white' }}
                      >
                        Agregar al carrito
                      </button>
                    </div>
